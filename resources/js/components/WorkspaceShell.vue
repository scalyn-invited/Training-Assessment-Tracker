...
const links = computed(() => [{ to: '/workspace', title: 'Overview', icon: '▦' }, { to: '/plans', title: 'Development plans', icon: '▤' }, { to: '/open-weeks', title: 'Open weeks', icon: '◷' }, ...(state.user?.role === 'administrator' ? [{ to: '/skills', title: 'Skills', icon: '◇' }, { to: '/members', title: 'Members', icon: '◎' }] : [])]);
</script>
<template>
    <div class="workspace">
        <aside class="sidebar">
